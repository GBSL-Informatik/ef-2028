...
<Answer type="string" label="URL zum EF-Repository" id="f2e01997-51e8-46a8-b340-77dc0f281a2d" />
...
Nun setzen wir die Struktur auf, um auch über unseren Code zu berichten. Erstellen/Ergänzen Sie dazu folgende Ordnerstruktur:
...
und halten Sie im Dokument __01-Einstieg.md__ einen Erfahrungsbericht zu den bisherigen Aufgaben fest. Darin können Sie einzelne neu gelernte Dinge, Stolpersteine, Tipps und Tricks, etc. festhalten. Stellen Sie sicher, dass Sie sowohl Python-Formatierte Codeblocks wie auch inline-Code verwenden.
:::