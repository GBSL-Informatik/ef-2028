...
:::details[Was stellen Sie beim Treppen-Programm fest?]
...
:::tip[Schleifentypen]
Mit **Schleifen** können also Anweisungen wiederholt ausgeführt werden, ohne dass diese mehrfach aufgeschrieben werden müssen. Es gibt zwei Arten von Schleifen:
...
Als erstes betrachten wir die bekannteste Zählschleife in Python, die `for`-Schleife.
:::
