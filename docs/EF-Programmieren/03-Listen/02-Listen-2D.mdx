...
page_id: ed319b4b-30d0-46ce-9150-9a68ba799e7d
---

# Zweidimensionale Listen

:::finding[Gut zu wissen…]
Im vorherigen Kapitel haben Sie vor allem Listen von Zahlen gesehen:

```py
noten = [3.5, 6, 5, 4.5]
```

Sie haben aber auch Listen gesehen, die keine Zahlen sondern sogenannte _Strings_ (also Text) enthalten:

```py
noten = ['gut', 'erfüllt', 'mangelhaft', 'erfüllt']
```

In Python können wir sämtliche Arten von Daten (Zahlen, Strings, Booleans[^1], etc.) in Listen abspeichern. **Folglich können die Elemente einer Liste auch selbst wiederum Listen sein.**
:::
...
::::aufgabe[`pretty_print()`]
<Answer type="state" id="32b77e06-fa29-4ed2-950c-e28b0259eb3c" />

Schreiben Sie eine Funktion `pretty_print` (Abkürzung für `Pretty Print`), welche eine 2D-Liste übersichtlich ausgibt:
...
```py live_py id=df2cf353-14ac-4676-b560-5024a4946db5 title=pretty_print.py
...
<Solution id="4f1b3847-4bd3-49ab-83dd-3b9982b33cd6">
...
::::aufgabe
<Answer type="state" id="c7a2e1a2-1476-4fcc-b4f9-fdcbdcc2a7b6" />
...
<Solution id="c5091336-dac5-440a-9b95-9b9f2d482b48">
...
<Answer type="state" id="302c5fcd-76d3-4fa7-aef0-c52b9d03422d" />
...
- siehe [Elemente zu einer Liste hinzufügen](./01-Listen-1D.mdx#element-hinzufügen-append)

:::

<Solution id="e8b99d8b-7838-4179-b4bb-8c7b8ceadedd">
...
<Solution id="e8b99d8b-7838-4179-b4bb-8c7b8ceadedd" title="⭐️ Lösung: Mit List-Comprehension">
...
<Solution id="3571eae1-ce0a-4a86-9373-dca332470f95">
...
<Answer type="state" id="c134f37d-8e4b-49e0-964e-355d202560bf" />
...
<Answer type="text" id="7ffc70a8-50a8-40a1-97d0-f30be4e54910" />
...
<Answer type="state" id="8131c3da-101f-44dd-8a32-3c8ff541186c" />
...
[^1]: _Booleans_ sind Werte, die entweder `True` ("wahr") oder `False` ("falsch") sein können. Wir verwenden sie z.B. bei Verzweigungen mit `if`.