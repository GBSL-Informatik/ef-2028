...
page_id: de38c04c-c7b6-4565-8778-dffc4686b4c2
---

# Listen Erzeugen

:::aufgabe
<Answer type="state" id="a4fb080a-8feb-443d-bf2d-5d7ddc92f685" />
...
:::aufgabe
<Answer type="state" id="306506df-f70e-4325-a3fd-30430288c666" />
...
<Solution id="b54e6cc1-6863-4bcc-86a7-bfeb328b2a7b">
...
:::
:::def[Leere `5x10`-Matrix]
`5x10`-Matrix gefüllt mit lauter Nullen (5 Zeilen, 10 Spalten)
```py live_py slim
_print = print
def print(mat):
...
`5x10`-Matrix mit aufsteigenden Werten.
