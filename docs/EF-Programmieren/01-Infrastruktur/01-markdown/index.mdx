...
<Quiz scoring={points(1)} randomizeQuestions randomizeOptions resetMode='incorrect' id="41bb12bf-c558-456d-8b38-8d865700e35a">
   ...
   <ChoiceAnswer correct={[1, 2, 5]} multiple scoring={multipleChoicePoints(2, 1)} title="Allgemeines zu Markdown">
...
:::info[Leere Ordner]
Falls bei Ihnen der Ordner __EF-Informatik/docs/images__ leer ist, wird dieser Ordner nicht direkt auf GitHub erstellt. Dies ist eine Speicherplatzoptimierung von Git.
:::
::::
